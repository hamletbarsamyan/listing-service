...
import am.jsl.listings.config.EhCacheConfig;
import am.jsl.listings.config.SpringMailConfig;
 ...
 */
@Configuration
@ComponentScan(basePackages = {"am.jsl.listings.dao", "am.jsl.listings.service"})
