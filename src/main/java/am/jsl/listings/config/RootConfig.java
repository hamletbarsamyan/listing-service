...
import am.jsl.listings.service.databasedump.DatabaseDumpJob;
import am.jsl.listings.service.databasedump.DatabaseDumpService;
import am.jsl.listings.service.reminder.ReminderJob;
import am.jsl.listings.service.reminder.ReminderService;
import org.quartz.*;
...
@ComponentScan(basePackages = {"am.jsl.listings"})
public class RootConfig {
    /**
     * Cron expression for database dump job.
     */
    @Value("${listings.db.export.cronExpression}")
    private String dbDumpCronExp;

    /**
     * Cron expression for reminder processing job.
     */
    @Value("${listings.reminder.cronExpression}")
