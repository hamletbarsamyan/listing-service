...
/**
 * {@link RowMapper} implementation that converts a row into a new UserProfileDTO instance.
 * @author hamlet
 */
public class UserProfileDTOMapper implements RowMapper<UserProfileDTO> {
