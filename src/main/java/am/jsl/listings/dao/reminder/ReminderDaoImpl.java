...
import am.jsl.listings.dao.reminder.mapper.ReminderDetailsMapper;
import am.jsl.listings.dao.reminder.mapper.ReminderListDTOMapper;
import am.jsl.listings.dao.reminder.mapper.ReminderLookupMapper;
import am.jsl.listings.dao.reminder.mapper.ReminderMapper;
import am.jsl.listings.domain.reminder.Reminder;
import am.jsl.listings.domain.reminder.ReminderStatus;
import am.jsl.listings.domain.user.UserStatus;
...
public class ReminderDaoImpl extends BaseDaoImpl<Reminder> implements ReminderDao {
    ...
    private void deleteReminderTransfer(long reminderId) {
        parameterJdbcTemplate.update(deleteReminderTransferSql,
                Collections.singletonMap(DBUtils.reminder_id, reminderId));
    }
...
//        params.put(DBUtils.user_id, reminder.getUserId());
    ...
    public Reminder get(long id) {
        Reminder reminder = get(id, getSql, reminderMapper);
