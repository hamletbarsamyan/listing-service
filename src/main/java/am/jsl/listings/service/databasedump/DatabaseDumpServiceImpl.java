package am.jsl.listings.service.databasedump;
...
public class DatabaseDumpServiceImpl implements DatabaseDumpService {
    ...
    @Value("${listings.db.export.enabled}")
    private boolean exportEnabled;

    @Value("${listings.db.export.cmd}")
    private String exportCmd;

    @Value("${listings.db.export.file.prefix}")
    private String exportFilePrefix;

    @Value("${listings.db.export.filedir}")
    private String exportFiledir;

    @Value("${listings.db.export.files_count}")
